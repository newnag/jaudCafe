<head>
  ...
  */ ?>
  ...
  <link rel="preload stylesheet" as="style" onload="this.rel='stylesheet'" href="/css/jaudStyle.min.css?v=1.1.1.2<?=time()?>">
  <link rel="preload stylesheet" as="style" onload="this.rel='stylesheet'" href="/plugin/OwlCarousel/dist/assets/owl.carousel.min.css">
  <link rel="preload stylesheet" as="style" onload="this.rel='stylesheet'" href="/plugin/OwlCarousel/dist/assets/owl.theme.default.min.css">
  <!-- <link rel="preload stylesheet" as="style" onload="this.rel='stylesheet'" href="https://cdn.jsdelivr.net/npm/flatpickr/dist/flatpickr.min.css"> -->
  <link rel="preload stylesheet" as="style" onload="this.rel='stylesheet'" href="/css/selectMulti.css?v=1.0.0">
  <link rel="preload stylesheet" as="style" onload="this.rel='stylesheet'" href="/css/cssDisplayTable.min.css">

  
  <script async defer src="/js/jquery/jquery-3.5.1.min.js"></script>
